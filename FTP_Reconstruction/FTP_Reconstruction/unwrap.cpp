...
//		{
//			WrappedImage[j*image_height + i] = tmpImg.at<float>(i, j);
//		}
//	}
//
//	//按行将像素存入数组
...
//	//	for (int j = 0; j < image_width; ++j)
//	//	{
//	//		WrappedImage[i*image_width + j] = tmpImg.at<float>(i, j);
//	//	}
//	//}
//
...
//		for (int i = 0; i<image_height; i++)
//		{
//			dst.at<float>(i, j) = (float)UnwrappedImage[j*image_height + i];
//		}
//	}
//
//	//按行将数组元素放入Mat
...
//	//	for (int j = 0; j < image_width; ++j)
//	//	{
//	//		dst.at<float>(i, j) = WrappedImage[i*image_width + j];
//	//	}
//	//}
//	
//	free(edge);
