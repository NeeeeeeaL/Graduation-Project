...
QT_MOC_LITERAL(3, 22, 27) // "on_pushButtonSwitch_clicked"

    },
    "childWindow\0mySignal\0\0on_pushButtonSwitch_clicked"
};
...
void childWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&childWindow::mySignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject childWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_childWindow.data,
      qt_meta_data_childWindow,  qt_static_metacall, nullptr, nullptr}
};
